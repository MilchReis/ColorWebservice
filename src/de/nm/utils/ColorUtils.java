...
public class ColorUtils {
	...
	public static final ArrayList<ColorName> COLOR_LIST = getColorList();

	/**
	 * Initialize the color list that we have.
	 */
	private static ArrayList<ColorName> getColorList() {
	...
	public String getColorHexByName(String name) {
		ColorName col = COLOR_LIST.stream()
				.filter(c -> c.name.equals(name))
				.findFirst()
				.get();
		
		return new de.nm.model.Color(col.r, col.g, col.b).getHex();
	}
	...
	public String getColorNameFromRgb(int r, int g, int b) {
		ArrayList<ColorName> colorList = getColorList();
